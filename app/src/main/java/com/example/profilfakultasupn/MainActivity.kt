...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prodi_parts.adapter =
            ProdiAdapter(testData) { prodiItem: ProdiData -> klikProdiItem(prodiItem) }
    }

    private fun klikProdiItem(prodiItem: ProdiData) {
        ...
        showDetailActivityIntent.putExtra(Intent.EXTRA_TEXT, prodiItem.isiFakultas)
